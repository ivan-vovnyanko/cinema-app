...
public class MovieSessionController {
    ...
    public MovieSessionResponseDto add(@RequestBody @Valid MovieSessionRequestDto requestDto) {
        logger.info("Add movie session was called. Movie id: " + requestDto.getMovieId()
                + ", cinema hall id: " + requestDto.getCinemaHallId()
                + ", show time: " + requestDto.getShowTime());
    ...
    public MovieSessionResponseDto update(@PathVariable Long id,
        ...
        logger.info("Update movie session request was called. Session id: " + id
                + ", movie id: " + requestDto.getMovieId()
                + ", cinema hall id: " + requestDto.getCinemaHallId()
                + ", show time: " + requestDto.getShowTime());
        MovieSession movieSession = movieSessionRequestDtoMapper.mapToModel(requestDto);
    ...
    public void delete(@PathVariable Long id) {
        logger.info("Delete movie session request was called. Movie session id: " + id);
